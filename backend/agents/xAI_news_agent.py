"""
xAI News Agent
Scrapes news articles from x.ai/blog based on date range.
"""
...
if __name__ == "__main__":
    # agent = XAINewsAgent(start_date="2025-12-20", end_date="2026-01-04")
    agent = XAINewsAgent(start_date, end_date)
    results = agent.run()
