# backend2/agents2/processors/scorer_tagger.py
"""
    ...
    def run(self, articles: list) -> list:
        ...
        for i, article in enumerate(articles):
            ...
            try:
                ...
                # Add exposure_score bonus
                exposure = article.get('exposure_score', 0)
                article['impactScore'] = min(100, article['impactScore'] + exposure * 2)
        ...
        for i, article in enumerate(articles):
            ...
            try:
                ...
                # Merge data
                article['title'] = tag_data.get('title', article.get('raw_title', ''))
                article['summary'] = tag_data.get('summary', '')
